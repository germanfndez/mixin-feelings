...
export const PlayList = () => {
	...
	return (
		<aside
			className={`${existPlaylist ? 'lg:w-1/2 w-full transition-custom p-5' : 'w-0'
...
export const PlayListItem = ({ name, href, images }: Playlist) => {
	return (
		<a href={href} target='_blank' className='backdrop-blur-lg bg-black/20 rounded-md flex justify-start gap-5 items-center w-full cursor-pointer shadow-lg hover:shadow-indigo-900/50 transition-all group flex-1 fadeInUp'>
